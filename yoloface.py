...
def _main():
    ...
    if args.image:
        ...
        #cap = cv2.VideoCapture('rtsp://192.168.254.68:8554/h264')
        
        cap = cv2.VideoCapture('rtsp://admin:9999@192.168.254.68:8554/h264')

        


    # email 객체 생성.
    send_email = utils.sendEmail()
    ...
    while True:
        ...
        print('[i] ==> # detected faces: {}'.format(len(faces))) # len을 하면 [[790, 200, 109, 119], [287, 174, 106, 113]] 이런식으로 나온다.
        print('#' * 60)
        print("뭐임? 3", frame.shape)
